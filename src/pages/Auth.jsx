      ...
      >
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-[10px] sm:text-xs text-dark2/50 mt-1.5 sm:mt-2 font-mono">
            {isForgotPassword ? 'Enter your email to receive a password reset link' : (isSignUp ? 'Join us to discover curated jewelry &amp; accessories' : 'Sign in to access your orders and wishlist')}
          </p>
        </div>
